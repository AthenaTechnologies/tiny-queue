...
test('limit test', function (t) {
    ...
    t.deepEqual(queue.slice(), [3, 4, 5, 6, 7]);
    t.deepEqual(queue.slice(2), [5, 6, 7]);
    t.deepEqual(queue.slice(1), [4, 5, 6, 7]);
    t.deepEqual(queue.slice(1, 2), [4]);
    t.deepEqual(queue.slice(2, 5), [5, 6, 7]);
